...
public class Lote extends InfoUIA{
    ...
    public Lote(String idLote, String descLote, String cantidad, String fechaIngreso, String idProv, String descProv, Embalaje embalaje)
    {
    ...
    public Embalaje getEmbalaje(){ return embalaje;}
